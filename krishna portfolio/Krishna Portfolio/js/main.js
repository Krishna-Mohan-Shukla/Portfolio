...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const pauseTime = 2000; // Pause time between roles (milliseconds)
  
    function typeRole() {
      if (charIndex < roles[index].length) {
        changingText.textContent += roles[index].charAt(charIndex);
        charIndex++;
    ...
    function deleteRole() {
      if (charIndex > 0) {
        changingText.textContent = roles[index].substring(0, charIndex - 1);
        charIndex--;
